    ...
    <section class="text-gray-700 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap -m-4" >
                <div class="p-4 md:w-1/3" v-for="searchResult in searchResults">
                    <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
                        <img class="lg:h-48 md:h-36 w-full object-cover object-center"
                             :src="searchResult.snippet.thumbnails.high.url" alt="blog">
                        <div class="p-6">
...
<!--                                CATEGORY</h2>-->
                            ...
                            <div class="flex items-center flex-wrap ">
                                ...
                                <a v-if="searchResult.id.channelId !== null" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0"
                                   :href="getVideosUrlChannel(searchResult.id.channelId)"> View channel videos
                                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor"
                                         stroke-width="2" fill="none" stroke-linecap="round"
                                         stroke-linejoin="round">
                                        <path d="M5 12h14"></path>
...
<!--              </span>-->
            ...
            <div v-if="searchResults === 0">
                <p>No Results Found please refine the search.</p>
            </div>
        </div>
    </section>
</template>
